...
```{r}
#Display Summaries for some of the Quantitative Variables
summary(studentDS$Curricular.units.1st.sem..grade.)
summary(studentDS$Curricular.units.2nd.sem..grade.)
summary(studentDS$Curricular.units.1st.sem..enrolled.)
summary(studentDS$Curricular.units.2nd.sem..enrolled.)
summary(studentDS$Curricular.units.1st.sem..credited.)
summary(studentDS$Curricular.units.2nd.sem..credited.)
summary(studentDS$Curricular.units.1st.sem..evaluations.)
summary(studentDS$Curricular.units.2nd.sem..evaluations.)
summary(studentDS$Curricular.units.1st.sem..approved.)
summary(studentDS$Curricular.units.2nd.sem..approved.)
summary(studentDS$Age.at.enrollment)
```
...
-  Here we see a right-skewed distribution of age at enrollment, which is expected.
...
- We will perform a backwards feature selkection based on AIC criterion, because we are interested in making predictions.
...
## MultiLevel Model
```{r}
model <- lmer(Unemployment.rate ~ Marital.status + Nationality + Application.mode + Previous.qualification + 
